...
namespace RoofStacksAuthGuardCase.AuthGuard.Services.Concrete
{
    public class AuthorizationInformationService : IAuthorizationInformationService
    {
        private readonly ConcurrentDictionary<string, AuthorizationInformation> _codeIssued = new ConcurrentDictionary<string, AuthorizationInformation>();
        ...
        public string GenerateAuthorizationCode(string clientId, IList<string> requestedScope)
        {
            ...
            if (client != null)
            {
                ...
                var authoCode = new AuthorizationInformation
                {
                    ClientId = clientId,
        ...
        public AuthorizationInformation GetClientDataByCode(string key)
        {
            AuthorizationInformation authorizationCode;
        ...
        public AuthorizationInformation RemoveClientDataByCode(string key)
        {
            AuthorizationInformation authorizationCode;
        ...
        public AuthorizationInformation UpdatedClientDataByCode(string key, IList<string> requestdScopes,
            string userName, string password = null, string nonce = null)
        {
            ...
            if (oldValue != null)
            {
                ...
                if (client != null)
                {
                    ...
                    AuthorizationInformation newValue = new AuthorizationInformation
                    {
