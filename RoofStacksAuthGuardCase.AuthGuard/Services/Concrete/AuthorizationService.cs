...
namespace RoofStacksAuthGuardCase.AuthGuard.Services.Concrete
{
    public class AuthorizationService : IAuthorizationService
    {
        ...
        private readonly IAuthorizationInformationService _codeStoreService;
        private readonly IHttpContextAccessor httpContextAccessor;
        public AuthorizationService(IAuthorizationInformationService codeStoreService,
        ...
        public AuthorizeResponse Authorize(AuthorizationRequest authorizationRequest)
        {
