...
using RoofStacksAuthGuardCase.AuthGuard.Endpoints;
...
namespace RoofStacksAuthGuardCase.AuthGuard.Controllers
{
    public class DiscoveryEndpointController : Controller
    {
        ...
        //        authorization_endpoint = "https://localhost:7178/security/authorize",
        //        token_endpoint = "https://localhost:7178/security/token",
        ...
        //        scopes_supported = new string[] { "openid", "profile", "email", "address", "phone", "offline_access" }, //TODO
        ...
        //        service_documentation = "https://localhost:7178/connect/service_documentation.html",
